...
export class LDAPContractorComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-ldap-contractor div table .btn-danger'));
  title = element.all(by.css('jhi-ldap-contractor div h2#page-heading span')).first();
...
export class LDAPContractorUpdatePage {
  pageTitle = element(by.id('jhi-ldap-contractor-heading'));
...
export class LDAPContractorDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-lDAPContractor-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-lDAPContractor'));
